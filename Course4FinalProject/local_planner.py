...
class LocalPlanner:
    ...
    def get_goal_state_set(self, goal_index, goal_state, waypoints, ego_state):
        ...
        # res = np.dot(goal_state_local[:2], rotation)
    ...
    def plan_paths(self, goal_state_set):
        ...
        paths = []
        path_validity = []
        # print("goal_state_set: ", goal_state_set) # [[13.87148721489471, -4.499914707749134, 4.261057743981667e-06, 8.333], [15.37148721489471, -2.9999147077491353, 4.261057743981667e-06, 8.333], [16.87148721489471, -1.4999147077491348, 4.261057743981667e-06, 8.333], [18.37148721489471, 8.529225086508415e-05, 4.261057743981667e-06, 8.333], [19.87148721489471, 1.5000852922508652, 4.261057743981667e-06, 8.333], [21.37148721489471, 3.0000852922508647, 4.261057743981667e-06, 8.333], [22.87148721489471, 4.500085292250866, 4.261057743981667e-06, 8.333]]
...
def transform_paths(paths, ego_state):
    ...
    # print("transformed_paths: ", transformed_paths)
